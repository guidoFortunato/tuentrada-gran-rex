    ...
    <nav className="navbar navbar-dark navbar-expand-lg color-navbar sticky-top animate__animated animate__fadeIn animate__faster">
      <div className="container">
        <div className="row w-100 justify-content-center">
          <div className="col-12 container-redes-nav mb-5 mb-lg-3">
            <div className="me-4">
              <span className="text-light h2">Seguinos en nuestras redes</span>
            </div>
            <div>
              <ul className="list-unstyled ms-auto d-flex mb-0">
                <li className="me-3">
                  <a
                    className="link-dark"
                    rel="noreferrer"
