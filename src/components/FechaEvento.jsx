      ...
      <div className="lg:flex lg:flex-row lg:justify-between border-b-2 border-gray-200 p-3">
        {
          availabilitLevel === "GOOD" && (
            <FechaDisponible dataFechas={dataFechas} dataEvento={dataEvento} dia={dia} hora={hora} mesFormateado={mesFormateado} anio={anio} openModal={openModal} setOpenModal={setOpenModal}  />
          )
        }
        {
          availabilitLevel === "LIMITED" && (
            <FechaLimited dataFechas={dataFechas} dataEvento={dataEvento} dia={dia} hora={hora} mesFormateado={mesFormateado} anio={anio} openModal={openModal} setOpenModal={setOpenModal}  />
          )
        }
        {
          availabilitLevel === "NONE" && reason == "SOLD_OUT" && (
            <FechaAgotada  dataFechas={dataFechas} dia={dia} hora={hora} mesFormateado={mesFormateado} anio={anio} openModal={openModal} setOpenModal={setOpenModal}  />
          )
        }
