...
import imgClose from "/assets/imagenes/close.svg";
...
export const DetalleEvento = ({ title, description, href, img, ubicaciones, imgPlano = "/assets/imagenes/planos/tue1.webp",}) => {
